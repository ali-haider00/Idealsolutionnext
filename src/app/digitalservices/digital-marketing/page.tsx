...
import { ArrowRight, CheckCircle, TrendingUp, Globe, Megaphone, Target } from 'lucide-react';
...
export default function DigitalMarketing() {
  const services = [
    {
      ...
      description: "Strategic social media campaigns to build brand awareness and engagement"
    },
    {
  ...
  const channels = [
    ...
    "Google Ads", "Email Campaigns", "Content Strategy",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed">
                Strategic digital marketing solutions that connect you with your audience and drive measurable business growth.
              </p>
            ...
            >
              <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-white mb-6">Marketing Results</h3>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-slate-300">Engagement Rate</span>
                    <span className="text-3xl font-bold text-cyan-400">+180%</span>
                  </div>
                  <div className="flex justify-between items-center">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive marketing solutions across all digital channels
            </p>
          </motion.div>
            ...
            {channels.map((channel, index) => (
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-3">{channel}</h3>
                  <p className="text-slate-600 leading-relaxed">Expert management and optimization</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-100 mb-10 leading-relaxed">
              Let's discuss how our digital marketing expertise can help you reach your goals
            </p>
            ...
            <Link href="/digitalservices/contact">
              ...
              >
                <span>Start Marketing Strategy</span>
                <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
              </motion.button>
            </Link>
          </motion.div>
